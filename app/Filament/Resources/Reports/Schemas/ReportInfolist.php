...
class ReportInfolist
{
                ...
                Section::make('Status & Penugasan')
                    ->schema([
                        TextEntry::make('status')
                            ->label('Status')
                            ->badge()
                            ->color(fn (ReportStatus $state): string => self::statusColor($state))
                            ->formatStateUsing(fn (ReportStatus $state): string => self::statusLabel($state)),
    ...
    private static function statusColor(ReportStatus $status): string
    {
        return match ($status) {
